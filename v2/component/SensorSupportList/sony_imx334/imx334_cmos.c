...
#include "imx334_cmos_param.h"

#define DIV_0_TO_1(a)   ((0 == (a)) ? 1 : (a))
#define DIV_0_TO_1_FLOAT(a) ((((a) < 1E-10) && ((a) > -1E-10)) ? 1 : (a))
#define IMX334_ID 334

#define SENSOR_IMX334_8M_WIDTH  3840
#define SENSOR_IMX334_8M_HEIGHT 2160
#define IMX334_I2C_ADDR_1 0x36
#define IMX334_I2C_ADDR_2 0x1A
#define IMX334_I2C_ADDR_IS_VALID(addr)      ((addr) == IMX334_I2C_ADDR_1 || (addr) == IMX334_I2C_ADDR_2)
/****************************************************************************
 * global variables                                                         *
 ****************************************************************************/

ISP_SNS_STATE_S *g_pastImx334[VI_MAX_PIPE_NUM] = {CVI_NULL};
SNS_COMBO_DEV_ATTR_S* g_pastImx334ComboDevArray[VI_MAX_PIPE_NUM] = {CVI_NULL};
...
#define IMX334_SENSOR_RESET_CTX(dev)         (g_pastImx334[dev] = CVI_NULL)
#define IMX334_SENSOR_SET_COMBO(dev, pstCtx)   (g_pastImx334ComboDevArray[dev] = pstCtx)
#define IMX334_SENSOR_GET_COMBO(dev, pstCtx)   (pstCtx = g_pastImx334ComboDevArray[dev])

ISP_SNS_COMMBUS_U g_aunImx334_BusInfo[VI_MAX_PIPE_NUM] = {
	[0] = { .s8I2cDev = 2},
	[1 ... VI_MAX_PIPE_NUM - 1] = { .s8I2cDev = -1}
};

ISP_SNS_COMMADDR_U g_aunImx334_AddrInfo[VI_MAX_PIPE_NUM] = {
	[0] = { .s8I2cAddr = 0},
	[1 ... VI_MAX_PIPE_NUM - 1] = { .s8I2cAddr = -1}
};
CVI_U16 g_au16Imx334_GainMode[VI_MAX_PIPE_NUM] = {0};

IMX334_STATE_S g_astImx334_State[VI_MAX_PIPE_NUM] = {{0} };
ISP_SNS_MIRRORFLIP_TYPE_E g_aeImx334_MirrorFip[VI_MAX_PIPE_NUM] = {0};
...
/*****Imx334 Lines Range*****/
#define IMX334_FULL_LINES_MAX  (0xFFFFF)
#define IMX334_VMAX_8M30_LINEAR	0x8CA
#define IMX334_VMAX_8M60_LINEAR	0x465

/*****Imx334 Register Address*****/
#define IMX334_HOLD_ADDR        0x3001

#define IMX334_SHR0_ADDR        0x3058 //shutter time
#define IMX334_SHR1_ADDR        0x305C

#define IMX334_GAIN_ADDR        0x30E8 //gain
#define IMX334_GAIN_SHORT_ADDR  0x30EA

#define IMX334_VMAX_ADDR        0x3030 //vmax

#define IMX334_YOUT_ADDR        0x3308 //window, the number of effective pixel lines

#define IMX334_RHS1_ADDR        0x3068
#define IMX334_TABLE_END        0xffff

#define IMX334_RES_IS_8M(w, h)      ((w) == SENSOR_IMX334_8M_WIDTH && (h) == SENSOR_IMX334_8M_HEIGHT)
static CVI_S32 cmos_get_ae_default(VI_PIPE ViPipe, AE_SENSOR_DEFAULT_S *pstAeSnsDft)
{
	...
	case WDR_MODE_NONE:   /*linear mode*/
		if (pstSnsState->u8ImgMode == IMX334_MODE_8M60) {
			pstAeSnsDft->f32Fps = g_astImx334_mode[IMX334_MODE_8M60].f32MaxFps;
			pstAeSnsDft->f32MinFps = g_astImx334_mode[IMX334_MODE_8M60].f32MinFps;
		} else {
			pstAeSnsDft->f32Fps = g_astImx334_mode[IMX334_MODE_8M30].f32MaxFps;
			pstAeSnsDft->f32MinFps = g_astImx334_mode[IMX334_MODE_8M30].f32MinFps;
		}
	...
	case WDR_MODE_2To1_LINE:
		pstAeSnsDft->f32Fps = g_astImx334_mode[IMX334_MODE_8M30_WDR].f32MaxFps;
		pstAeSnsDft->f32MinFps = g_astImx334_mode[IMX334_MODE_8M30_WDR].f32MinFps;
...
{
	ISP_SNS_STATE_S *pstSnsState = CVI_NULL;
	CVI_U32 u32VMAX = IMX334_VMAX_8M30_LINEAR;
	...
	u32Vts = g_astImx334_mode[pstSnsState->u8ImgMode].u32VtsDef;
	pstSnsRegsInfo = &pstSnsState->astSyncInfo[0].snsCfg;
	f32MaxFps = g_astImx334_mode[pstSnsState->u8ImgMode].f32MaxFps;
	f32MinFps = g_astImx334_mode[pstSnsState->u8ImgMode].f32MinFps;
	...
	if ((pstSnsState->u8ImgMode == IMX334_MODE_8M30_WDR) && (u32VMAX % 4))
		u32VMAX = u32VMAX - (u32VMAX % 4) + 4;

	u32VMAX = (u32VMAX > IMX334_FULL_LINES_MAX) ? IMX334_FULL_LINES_MAX : u32VMAX;
	...
	if (WDR_MODE_2To1_LINE == pstSnsState->enWDRMode) {
		...
		g_astImx334_State[ViPipe].u32RHS1_MAX = 2 * (u32VMAX - g_astImx334_State[ViPipe].u32BRL) - 1;
		if ((g_astImx334_State[ViPipe].u32RHS1_MAX % 4) != 1)
			g_astImx334_State[ViPipe].u32RHS1_MAX =
				(((g_astImx334_State[ViPipe].u32RHS1_MAX + 3) >> 2) << 2) - 3;
	} else {
...
/*
 * DOL mode
 * SHR1 : 9 <= SHR1 <= (RHS1 - 2), 2n + 1
 * RHS1 : (SHR1 + 2) <= RHS1 <= (SHR0 - 9), 4n + 1, within FSC mode, RHS1 < 2 * (VMAX - BRL) - 1
 * SHR0 : (RHS1 + 9) <= SHR0 <= (FSC - 2), 2n
 * Max Sexp = RHS1 - SHR1 = RHS1 - 9
 * Max Lexp = FSC - SHR0 = FSC - RHS1 - 9
 * Max Sexp + Lexp = FSC - 18
 * Sexp = (FSC - 18) / (1 + Ratio)
...
static CVI_S32 cmos_inttime_update(VI_PIPE ViPipe, CVI_U32 *u32IntTime)
{
	...
	if (WDR_MODE_2To1_LINE == pstSnsState->enWDRMode) {
		...
		if (pstSnsState->au32FL[1] < u32LongIntTime + 2) {
		...
		/* SHS1 is 9 or 11.
		 * when tSef is multiple of 4, SHS1 = 9, RHS1 = 9 + tSEF = 4*n+1.
		 * otherwise, when mod(tSef, 4) = 3, 2, SHS1 = 11, RHS1 = 11 + tSEF - mod(tSef, 2) = 4*n+1.
		 * when mod(tSef,4) = 0 or 1, SHS1 = 9, RHS1 = 9 + tSEF - mod(tSef, 2) = 4*n+1
		 */
		if (!module4) {
			u32SHR1 = 9;
			u32RHS1 = u32ShortIntTime + u32SHR1;
			g_astImx334_State[ViPipe].u32RHS1 = u32RHS1;
		} else {
			if (module4 == module2) {
				u32SHR1 = 9;
...
static CVI_S32 cmos_gains_update(VI_PIPE ViPipe, CVI_U32 *pu32Again, CVI_U32 *pu32Dgain)
{
	ISP_SNS_STATE_S *pstSnsState = CVI_NULL;
	ISP_SNS_REGS_INFO_S *pstSnsRegsInfo = CVI_NULL;
	CVI_U32 u16Mode = g_au16Imx334_GainMode[ViPipe];
	CVI_U32 u32Tmp;
	CVI_U32 u32Again;
	CVI_U32 u32Dgain;
	...
	if (pstSnsState->enWDRMode == WDR_MODE_NONE) {
		...
		pstSnsRegsInfo->astI2cData[LINEAR_GAIN_H].u32Data = ((u32Tmp & 0x700) >> 8);
			syslog(LOG_DEBUG, "LINEAR_GAIN_L = %d LINEAR_GAIN_H = %d\n",
				pstSnsRegsInfo->astI2cData[LINEAR_GAIN_L].u32Data, pstSnsRegsInfo->astI2cData[LINEAR_GAIN_H].u32Data);
	} else {
		/* DOL mode */
		...
		CVI_U32 *au32IntTimeMax, CVI_U32 *au32IntTimeMin, CVI_U32 *pu32LFMaxIntTime)
{
	...
	if (WDR_MODE_2To1_LINE == pstSnsState->enWDRMode) {
		if (genFSWDRMode[ViPipe] == ISP_FSWDR_LONG_FRAME_MODE) {
			u32IntTimeMaxTmp = pstSnsState->au32FL[0] - 20;
			au32IntTimeMax[0] = u32IntTimeMaxTmp;
			au32IntTimeMin[0] = u32ShortTimeMinLimit;
			return CVI_SUCCESS;
		}
		u32IntTimeMaxTmp0 = ((pstSnsState->au32FL[1] - 20 - pstSnsState->au32WDRIntTime[0]) * 0x40) /
						DIV_0_TO_1(au32Ratio[0]);
		u32IntTimeMaxTmp  = ((pstSnsState->au32FL[0] - 20) * 0x40)  / DIV_0_TO_1(au32Ratio[0] + 0x40);
		u32IntTimeMaxTmp = (u32IntTimeMaxTmp > u32IntTimeMaxTmp0) ? u32IntTimeMaxTmp0 : u32IntTimeMaxTmp;
		u32IntTimeMaxTmp  = (u32IntTimeMaxTmp > (g_astImx334_State[ViPipe].u32RHS1_MAX - 11)) ?
						(g_astImx334_State[ViPipe].u32RHS1_MAX - 11) : u32IntTimeMaxTmp;
...
static CVI_S32 cmos_get_wdr_size(VI_PIPE ViPipe, ISP_SNS_ISP_INFO_S *pstIspCfg)
{
	const IMX334_MODE_S *pstMode = CVI_NULL;
	ISP_SNS_STATE_S *pstSnsState = CVI_NULL;

	IMX334_SENSOR_GET_CTX(ViPipe, pstSnsState);
	CMOS_CHECK_POINTER(pstSnsState);
	pstMode = &g_astImx334_mode[pstSnsState->u8ImgMode];
...
static CVI_S32 cmos_set_wdr_mode(VI_PIPE ViPipe, CVI_U8 u8Mode)
{
	...
	switch (u8Mode) {
	case WDR_MODE_NONE:
		if (pstSnsState->u8ImgMode == IMX334_MODE_8M30_WDR)
			pstSnsState->u8ImgMode = IMX334_MODE_8M30;
		/* Keep the current linear mode (8M30 or 8M60) if already in linear mode */
		pstSnsState->enWDRMode = WDR_MODE_NONE;
		pstSnsState->u32FLStd = g_astImx334_mode[pstSnsState->u8ImgMode].u32VtsDef;
		syslog(LOG_INFO, "WDR_MODE_NONE\n");
		break;

	case WDR_MODE_2To1_LINE:
		if (pstSnsState->u8ImgMode == IMX334_MODE_8M30)
			pstSnsState->u8ImgMode = IMX334_MODE_8M30_WDR;
		else if (pstSnsState->u8ImgMode == IMX334_MODE_8M60) {
			/* 8M60 does not support WDR mode, switch to 8M30 WDR */
			pstSnsState->u8ImgMode = IMX334_MODE_8M30_WDR;
		}
		pstSnsState->enWDRMode = WDR_MODE_2To1_LINE;
		pstSnsState->u32FLStd = g_astImx334_mode[pstSnsState->u8ImgMode].u32VtsDef * 2;
		g_astImx334_State[ViPipe].u32BRL  = g_astImx334_mode[pstSnsState->u8ImgMode].u16BRL;
		break;
	default:
...
static CVI_S32 cmos_get_sns_regs_info(VI_PIPE ViPipe, ISP_SNS_SYNC_INFO_S *pstSnsSyncInfo)
{
	...
	if ((pstSnsState->bSyncInit == CVI_FALSE) || (pstSnsRegsInfo->bConfig == CVI_FALSE)) {
		...
		pstCfg0->snsCfg.unComBus.s8I2cDev = g_aunImx334_BusInfo[ViPipe].s8I2cDev;
		...
		for (i = 0; i < pstCfg0->snsCfg.u32RegNum; i++) {
			...
			pstI2c_data[i].u8DevAddr = g_aunImx334_AddrInfo[ViPipe].s8I2cAddr;
			pstI2c_data[i].u32AddrByteNum = imx334_addr_byte;
			pstI2c_data[i].u32DataByteNum = imx334_data_byte;
		}

		switch (pstSnsState->enWDRMode) {
		case WDR_MODE_2To1_LINE:
			pstI2c_data[DOL2_SHR0_L].u32RegAddr = IMX334_SHR0_ADDR;
			pstI2c_data[DOL2_SHR0_M].u32RegAddr = IMX334_SHR0_ADDR + 1;
			pstI2c_data[DOL2_SHR0_H].u32RegAddr = IMX334_SHR0_ADDR + 2;

			pstI2c_data[DOL2_GAIN_L].u32RegAddr = IMX334_GAIN_ADDR;
			pstI2c_data[DOL2_GAIN_L].u8DelayFrmNum = 0;
			pstI2c_data[DOL2_GAIN_H].u32RegAddr = IMX334_GAIN_ADDR + 1;
			pstI2c_data[DOL2_GAIN_H].u8DelayFrmNum = 0;

			pstI2c_data[DOL2_GAIN_SHORT_L].u32RegAddr = IMX334_GAIN_SHORT_ADDR;
			pstI2c_data[DOL2_GAIN_SHORT_L].u8DelayFrmNum = 0;
			pstI2c_data[DOL2_GAIN_SHORT_H].u32RegAddr = IMX334_GAIN_SHORT_ADDR + 1;
			pstI2c_data[DOL2_GAIN_SHORT_H].u8DelayFrmNum = 0;

			pstI2c_data[DOL2_RHS1_L].u32RegAddr = IMX334_RHS1_ADDR;
			pstI2c_data[DOL2_RHS1_L].u8DelayFrmNum = 0;
			pstI2c_data[DOL2_RHS1_M].u32RegAddr = IMX334_RHS1_ADDR + 1;
			pstI2c_data[DOL2_RHS1_M].u8DelayFrmNum = 0;
			pstI2c_data[DOL2_RHS1_H].u32RegAddr = IMX334_RHS1_ADDR + 2;
			pstI2c_data[DOL2_RHS1_H].u8DelayFrmNum = 0;

			pstI2c_data[DOL2_SHR1_L].u32RegAddr = IMX334_SHR1_ADDR;
			pstI2c_data[DOL2_SHR1_M].u32RegAddr = IMX334_SHR1_ADDR + 1;
			pstI2c_data[DOL2_SHR1_H].u32RegAddr = IMX334_SHR1_ADDR + 2;

			pstI2c_data[DOL2_VMAX_L].u32RegAddr = IMX334_VMAX_ADDR;
			pstI2c_data[DOL2_VMAX_L].u8DelayFrmNum = 0;
			pstI2c_data[DOL2_VMAX_M].u32RegAddr = IMX334_VMAX_ADDR + 1;
			pstI2c_data[DOL2_VMAX_M].u8DelayFrmNum = 0;
			pstI2c_data[DOL2_VMAX_H].u32RegAddr = IMX334_VMAX_ADDR + 2;
			pstI2c_data[DOL2_VMAX_H].u8DelayFrmNum = 0;
			pstCfg0->ispCfg.u8DelayFrmNum = 1;
			break;
		default:
			pstI2c_data[LINEAR_SHR_L].u32RegAddr = IMX334_SHR0_ADDR;
			pstI2c_data[LINEAR_SHR_M].u32RegAddr = IMX334_SHR0_ADDR + 1;
			pstI2c_data[LINEAR_SHR_H].u32RegAddr = IMX334_SHR0_ADDR + 2;

			pstI2c_data[LINEAR_GAIN_L].u32RegAddr = IMX334_GAIN_ADDR;
			pstI2c_data[LINEAR_GAIN_H].u32RegAddr = IMX334_GAIN_ADDR + 1;

			pstI2c_data[LINEAR_VMAX_L].u32RegAddr = IMX334_VMAX_ADDR;
			pstI2c_data[LINEAR_VMAX_M].u32RegAddr = IMX334_VMAX_ADDR + 1;
			pstI2c_data[LINEAR_VMAX_H].u32RegAddr = IMX334_VMAX_ADDR + 2;
...
static CVI_S32 cmos_set_image_mode(VI_PIPE ViPipe, ISP_CMOS_SENSOR_IMAGE_MODE_S *pstSensorImageMode)
{
	...
	if (pstSensorImageMode->f32Fps <= 30) {
		if (pstSnsState->enWDRMode == WDR_MODE_NONE) {
			if (IMX334_RES_IS_8M(pstSensorImageMode->u16Width, pstSensorImageMode->u16Height))
				u8SensorImageMode = IMX334_MODE_8M30;
			else {
			...
			if (IMX334_RES_IS_8M(pstSensorImageMode->u16Width, pstSensorImageMode->u16Height))
				u8SensorImageMode = IMX334_MODE_8M30_WDR;
			else {
				CVI_TRACE_SNS(CVI_DBG_ERR, "Not support! Width:%d, Height:%d, Fps:%f, WDRMode:%d\n",
				       pstSensorImageMode->u16Width,
				       pstSensorImageMode->u16Height,
		...
		if (pstSnsState->enWDRMode == WDR_MODE_NONE) {
			if (IMX334_RES_IS_8M(pstSensorImageMode->u16Width, pstSensorImageMode->u16Height))
				u8SensorImageMode = IMX334_MODE_8M60;
			else {
				CVI_TRACE_SNS(CVI_DBG_ERR, "Not support! Width:%d, Height:%d, Fps:%f, WDRMode:%d\n",
				       pstSensorImageMode->u16Width,
				       pstSensorImageMode->u16Height,
...
static CVI_VOID sensor_mirror_flip(VI_PIPE ViPipe, ISP_SNS_MIRRORFLIP_TYPE_E eSnsMirrorFlip)
{
	...
	if (pstSnsState->bInit == CVI_TRUE && g_aeImx334_MirrorFip[ViPipe] != eSnsMirrorFlip) {
		imx334_mirror_flip(ViPipe, eSnsMirrorFlip);
		g_aeImx334_MirrorFip[ViPipe] = eSnsMirrorFlip;
	}
}
...
static CVI_VOID sensor_global_init(VI_PIPE ViPipe)
{
	...
	pstSnsState->enWDRMode = WDR_MODE_NONE;
	pstSnsState->u32FLStd  = g_astImx334_mode[pstSnsState->u8ImgMode].u32VtsDef;
	pstSnsState->au32FL[0] = g_astImx334_mode[pstSnsState->u8ImgMode].u32VtsDef;
	pstSnsState->au32FL[1] = g_astImx334_mode[pstSnsState->u8ImgMode].u32VtsDef;
...
static CVI_S32 sensor_rx_attr(VI_PIPE ViPipe, SNS_COMBO_DEV_ATTR_S *pstRxAttr)
{
	...
	IMX334_SENSOR_GET_CTX(ViPipe, pstSnsState);
	IMX334_SENSOR_GET_COMBO(ViPipe, pstRxAttrSrc);
	CMOS_CHECK_POINTER(pstSnsState);
	...
	pstRxAttr->img_size.width = g_astImx334_mode[pstSnsState->u8ImgMode].astImg[0].stSnsSize.u32Width;
	pstRxAttr->img_size.height = g_astImx334_mode[pstSnsState->u8ImgMode].astImg[0].stSnsSize.u32Height;
	if (pstSnsState->enWDRMode != WDR_MODE_NONE)
...
static CVI_S32 sensor_patch_rx_attr(VI_PIPE ViPipe, RX_INIT_ATTR_S *pstRxInitAttr)
{
	...
	if (!g_pastImx334ComboDevArray[ViPipe]) {
		pstRxAttr = malloc(sizeof(SNS_COMBO_DEV_ATTR_S));
	} else {
		IMX334_SENSOR_GET_COMBO(ViPipe, pstRxAttr);
	}
	memcpy(pstRxAttr, &imx334_rx_attr, sizeof(SNS_COMBO_DEV_ATTR_S));
	IMX334_SENSOR_SET_COMBO(ViPipe, pstRxAttr);
...
{
	if (g_pastImx334ComboDevArray[ViPipe]) {
		free(g_pastImx334ComboDevArray[ViPipe]);
		g_pastImx334ComboDevArray[ViPipe] = CVI_NULL;
	}
...
{
	if (IMX334_I2C_ADDR_IS_VALID(s32I2cAddr))
		g_aunImx334_AddrInfo[ViPipe].s8I2cAddr = s32I2cAddr;
	else {
		CVI_TRACE_SNS(CVI_DBG_ERR, "I2C addr input error ,please check [0x%x]\n", s32I2cAddr);
		g_aunImx334_AddrInfo[ViPipe].s8I2cAddr = IMX334_I2C_ADDR_2;
	}
}

static CVI_S32 imx334_set_bus_info(VI_PIPE ViPipe, ISP_SNS_COMMBUS_U unSNSBusInfo)
{
	g_aunImx334_BusInfo[ViPipe].s8I2cDev = unSNSBusInfo.s8I2cDev;
...
static CVI_S32 sensor_unregister_callback(VI_PIPE ViPipe, ALG_LIB_S *pstAeLib, ALG_LIB_S *pstAwbLib)
{
	...
	s32Ret = CVI_ISP_SensorUnRegCallBack(ViPipe, IMX334_ID);
	if (s32Ret != CVI_SUCCESS) {
		CVI_TRACE_SNS(CVI_DBG_ERR, "sensor unregister callback function failed!\n");
		return s32Ret;
	}

	s32Ret = CVI_AE_SensorUnRegCallBack(ViPipe, pstAeLib, IMX334_ID);
	if (s32Ret != CVI_SUCCESS) {
		CVI_TRACE_SNS(CVI_DBG_ERR, "sensor unregister callback function to ae lib failed!\n");
		return s32Ret;
	}

	s32Ret = CVI_AWB_SensorUnRegCallBack(ViPipe, pstAwbLib, IMX334_ID);
	if (s32Ret != CVI_SUCCESS) {
...
static CVI_S32 sensor_set_init(VI_PIPE ViPipe, ISP_INIT_ATTR_S *pstInitAttr)
{
	...
	g_au16Imx334_GainMode[ViPipe] = pstInitAttr->enGainMode;

	return CVI_SUCCESS;
}

ISP_SNS_OBJ_S stSnsImx334_Obj = {
