#ifndef __IMX135_CMOS_PARAM_H_
#define __IMX135_CMOS_PARAM_H_
...
static const IMX135_MODE_S g_astImx135_mode[IMX135_MODE_NUM] = {
	[IMX135_MODE_8M25] = {
			.name = "IMX135_8M25",
			.astImg[0] = {
				.stSnsSize = {
...
static ISP_CMOS_NOISE_CALIBRATION_S g_stIspNoiseCalibratio = {.CalibrationCoef = {
	...
	{	//iso  400
		{0.04830884913571679688,	8.92552661895751953125}, //B: slope, intercept
	...
	{	//iso  6400
		...
		{0.09082328528165817261,	77.31325531001359375000}, //Gr: slope, intercept
	...
	{	//iso  12800
		...
		{0.12440066039562225342,	117.71653747513593750000}, //Gr: slope, intercept
...
struct combo_dev_attr_s imx135_rx_attr = {
