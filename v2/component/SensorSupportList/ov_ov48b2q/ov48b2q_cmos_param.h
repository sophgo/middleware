#ifndef __OV48B2Q_CMOS_PARAM_H_
#define __OV48B2Q_CMOS_PARAM_H_
...
static const OV48B2Q_MODE_S g_astOv48b2q_mode[OV48B2Q_MODE_NUM] = {
	[OV48B2Q_MODE_8M30] = {
		.name = "8M30",
		.astImg[0] = {
			.stSnsSize = {
	...
	[OV48B2Q_MODE_12M10_PD] = {
		...
		.f32MaxFps = 10,
		.f32MinFps = 0.0, /* 0x1194 * 30 / 0xFFFFF */
		.u32HtsDef = 0x0c60,	// 0x380c 0x380d
		.u32VtsDef = 0x0e34,	// 0x380e 0x380f
		.stExp[0] = {
			.u16Min = 8,
			.u16Max = 0x0e34 - 22,
			.u16Def = 8,
...
struct combo_dev_attr_s ov48b2q_rx_attr = {
	.input_mode = INPUT_MODE_MIPI,
	.mac_clk = RX_MAC_CLK_900M,
	.mipi_attr = {
		.raw_data_type = RAW_DATA_10BIT,
		.lane_id = {2, 3, 1, 4, 0, -1, -1, -1, -1},
