...
{
	return sensor_i2c_init(ViPipe, (CVI_U8)g_aunOs02g10_BusInfo[ViPipe].s8I2cDev,
							(CVI_U8)g_aunOs02g10_AddrInfo[ViPipe].s8I2cAddr);
}

int os02g10_i2c_exit(VI_PIPE ViPipe)
{
	return sensor_i2c_exit(ViPipe, (CVI_U8)g_aunOs02g10_BusInfo[ViPipe].s8I2cDev);
}

int os02g10_read_register(VI_PIPE ViPipe, int addr)
{
	return sensor_i2c_read(ViPipe, (CVI_U8)g_aunOs02g10_BusInfo[ViPipe].s8I2cDev,
							(CVI_U8)g_aunOs02g10_AddrInfo[ViPipe].s8I2cAddr, (CVI_U32)addr,
							os02g10_addr_byte, os02g10_data_byte);

}

int os02g10_write_register(VI_PIPE ViPipe, int addr, int data)
{
	return sensor_i2c_write(ViPipe, (CVI_U8)g_aunOs02g10_BusInfo[ViPipe].s8I2cDev,
							(CVI_U8)g_aunOs02g10_AddrInfo[ViPipe].s8I2cAddr, (CVI_U32)addr,
							os02g10_addr_byte, (CVI_U32)data, os02g10_data_byte);
}
