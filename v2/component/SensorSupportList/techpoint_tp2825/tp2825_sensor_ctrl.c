...
void tp2825_1080p30_init_setting(VI_PIPE ViPipe) {
	tp2825_write_register(ViPipe, 0x02, 0x40);
	...
	tp2825_write_register(ViPipe, 0x12, 0x40);
	tp2825_write_register(ViPipe, 0x13, 0x00);
	tp2825_write_register(ViPipe, 0x14, 0x00);
	tp2825_write_register(ViPipe, 0x15, 0x03);
	tp2825_write_register(ViPipe, 0x16, 0xD2);
	tp2825_write_register(ViPipe, 0x17, 0x80);
	tp2825_write_register(ViPipe, 0x18, 0x29);
	tp2825_write_register(ViPipe, 0x19, 0x38);
	tp2825_write_register(ViPipe, 0x1A, 0x47);
	tp2825_write_register(ViPipe, 0x1B, 0x01);
	tp2825_write_register(ViPipe, 0x1C, 0x08);
	tp2825_write_register(ViPipe, 0x1D, 0x98);
	tp2825_write_register(ViPipe, 0x1E, 0x80);
	tp2825_write_register(ViPipe, 0x1F, 0x80);
	tp2825_write_register(ViPipe, 0x20, 0x30);
	...
	tp2825_write_register(ViPipe, 0x27, 0x2D);
	...
	tp2825_write_register(ViPipe, 0x2C, 0x0A);
	tp2825_write_register(ViPipe, 0x2D, 0x30);
	tp2825_write_register(ViPipe, 0x2E, 0x70);
	tp2825_write_register(ViPipe, 0x2F, 0x00);
	tp2825_write_register(ViPipe, 0x30, 0x48);
	tp2825_write_register(ViPipe, 0x31, 0xBB);
	tp2825_write_register(ViPipe, 0x32, 0x2E);
	tp2825_write_register(ViPipe, 0x33, 0x90);
	tp2825_write_register(ViPipe, 0x34, 0x00);
	tp2825_write_register(ViPipe, 0x35, 0x05);
	tp2825_write_register(ViPipe, 0x36, 0xDC);
	tp2825_write_register(ViPipe, 0x37, 0x00);
	tp2825_write_register(ViPipe, 0x38, 0x40);
	tp2825_write_register(ViPipe, 0x39, 0x1C);
	tp2825_write_register(ViPipe, 0x3A, 0x32);
	...
	tp2825_write_register(ViPipe, 0xF7, 0x44);
	tp2825_write_register(ViPipe, 0xF8, 0x00);
	tp2825_write_register(ViPipe, 0xF9, 0x00);
	tp2825_write_register(ViPipe, 0xFA, 0x0b);
	tp2825_write_register(ViPipe, 0xFB, 0x00);
	tp2825_write_register(ViPipe, 0xFC, 0x00);
	tp2825_write_register(ViPipe, 0xFD, 0x80);
	tp2825_write_register(ViPipe, 0xFE, 0x28);
	tp2825_write_register(ViPipe, 0x40, 0x08);
	tp2825_write_register(ViPipe, 0x13, 0x04);
	tp2825_write_register(ViPipe, 0x40, 0x00);

	printf("ViPipe:%d,===tp2825 1080P 30fps 10bit LINE Init OK!===\n", ViPipe);
}

void tp2825_1080p60_init_setting(VI_PIPE ViPipe, CVI_U8 mode) {
	tp2825_write_register(ViPipe, 0x40, 0x00);
	tp2825_write_register(ViPipe, 0x02, 0x50);
	tp2825_write_register(ViPipe, 0x06, 0x32);
	tp2825_write_register(ViPipe, 0x07, 0xC0);
	tp2825_write_register(ViPipe, 0x0B, 0xC0);
	tp2825_write_register(ViPipe, 0x0C, 0x03);
	...
	tp2825_write_register(ViPipe, 0x14, 0x00);
	tp2825_write_register(ViPipe, 0x15, 0x03);
	tp2825_write_register(ViPipe, 0x16, 0xf0);
	tp2825_write_register(ViPipe, 0x17, 0x80);
	tp2825_write_register(ViPipe, 0x18, 0x12);
	tp2825_write_register(ViPipe, 0x19, 0x38);
	tp2825_write_register(ViPipe, 0x1A, 0x47);
	tp2825_write_register(ViPipe, 0x1B, 0x01);
	if (mode == TP2825_MODE_1080P_60P) {
		tp2825_write_register(ViPipe, 0x1C, 0x08);
		tp2825_write_register(ViPipe, 0x1D, 0x96);
	} else if (mode == TP2825_MODE_1080P_50P) {
		tp2825_write_register(ViPipe, 0x1C, 0x0A);
		tp2825_write_register(ViPipe, 0x1D, 0x4E);
	}
	tp2825_write_register(ViPipe, 0x20, 0x38);
	tp2825_write_register(ViPipe, 0x21, 0x84);
	tp2825_write_register(ViPipe, 0x22, 0x36);
	tp2825_write_register(ViPipe, 0x23, 0x3C);
	tp2825_write_register(ViPipe, 0x25, 0xff);
	...
	tp2825_write_register(ViPipe, 0x2D, 0x40);
	tp2825_write_register(ViPipe, 0x2E, 0x70);
	tp2825_write_register(ViPipe, 0x30, 0x74);
	tp2825_write_register(ViPipe, 0x31, 0x9b);
	tp2825_write_register(ViPipe, 0x32, 0xa5);
	tp2825_write_register(ViPipe, 0x33, 0xe0);
	tp2825_write_register(ViPipe, 0x35, 0x05);
	tp2825_write_register(ViPipe, 0x36, 0xbc);
	tp2825_write_register(ViPipe, 0x39, 0x68);
	...
	tp2825_write_register(ViPipe, 0x4E, 0x0D);
	tp2825_write_register(ViPipe, 0x4F, 0x00);
	tp2825_write_register(ViPipe, 0xF3, 0x08);
	tp2825_write_register(ViPipe, 0xFA, 0x00);
	tp2825_write_register(ViPipe, 0xFD, 0x80);
	tp2825_write_register(ViPipe, 0x40, 0x08);
	tp2825_write_register(ViPipe, 0x13, 0x04);
	tp2825_write_register(ViPipe, 0x14, 0x73);
	tp2825_write_register(ViPipe, 0x40, 0x00);
	printf("ViPipe:%d,===tp2825 1080P 60fps 10bit LINE Init OK!===\n", ViPipe);
}

void tp2825_1440p_init_setting(VI_PIPE ViPipe, CVI_U8 mode)
{
	//unsigned char tmp;
	...
	printf("ViPipe:%d,===tp2825 1440P 30fps 10bit LINE Init OK!===\n", ViPipe);
}

void tp2825_720p_init_setting(VI_PIPE ViPipe) {
	tp2825_write_register(ViPipe, 0x02, 0x4A);
	tp2825_write_register(ViPipe, 0x05, 0x00);
	tp2825_write_register(ViPipe, 0x06, 0x32);
	tp2825_write_register(ViPipe, 0x07, 0xC0);
	tp2825_write_register(ViPipe, 0x08, 0x00);
	...
	tp2825_write_register(ViPipe, 0x0A, 0x48);
	tp2825_write_register(ViPipe, 0x0B, 0xC0);
	tp2825_write_register(ViPipe, 0x0C, 0x43);
	tp2825_write_register(ViPipe, 0x0D, 0x50);
	tp2825_write_register(ViPipe, 0x0E, 0x00);
	tp2825_write_register(ViPipe, 0x0F, 0x00);
	tp2825_write_register(ViPipe, 0x10, 0x00);
	...
	tp2825_write_register(ViPipe, 0x13, 0x00);
	tp2825_write_register(ViPipe, 0x14, 0x00);
	tp2825_write_register(ViPipe, 0x15, 0x13);
	tp2825_write_register(ViPipe, 0x16, 0x15);
	tp2825_write_register(ViPipe, 0x17, 0x00);
	tp2825_write_register(ViPipe, 0x18, 0x19);
	tp2825_write_register(ViPipe, 0x19, 0xD0);
	tp2825_write_register(ViPipe, 0x1A, 0x25);
	tp2825_write_register(ViPipe, 0x1B, 0x01);
	tp2825_write_register(ViPipe, 0x1C, 0x06);
	tp2825_write_register(ViPipe, 0x1D, 0x72);
	tp2825_write_register(ViPipe, 0x1E, 0x80);
	tp2825_write_register(ViPipe, 0x1F, 0x80);
	tp2825_write_register(ViPipe, 0x20, 0x30);
	tp2825_write_register(ViPipe, 0x21, 0x86);
	tp2825_write_register(ViPipe, 0x22, 0x38);
	tp2825_write_register(ViPipe, 0x23, 0x3C);
	tp2825_write_register(ViPipe, 0x24, 0x04);
	tp2825_write_register(ViPipe, 0x25, 0xFF);
	tp2825_write_register(ViPipe, 0x26, 0x05);
	...
	tp2825_write_register(ViPipe, 0x29, 0x48);
	tp2825_write_register(ViPipe, 0x2A, 0x30);
	tp2825_write_register(ViPipe, 0x2B, 0x4A);
	tp2825_write_register(ViPipe, 0x2C, 0x0A);
	tp2825_write_register(ViPipe, 0x2D, 0x30);
	tp2825_write_register(ViPipe, 0x2E, 0x70);
	tp2825_write_register(ViPipe, 0x2F, 0x00);
	...
	tp2825_write_register(ViPipe, 0x33, 0x90);
	tp2825_write_register(ViPipe, 0x34, 0x00);
	tp2825_write_register(ViPipe, 0x35, 0x25);
	tp2825_write_register(ViPipe, 0x36, 0xDC);
	tp2825_write_register(ViPipe, 0x37, 0x00);
	tp2825_write_register(ViPipe, 0x38, 0x00);
	tp2825_write_register(ViPipe, 0x39, 0x08);
	tp2825_write_register(ViPipe, 0x3A, 0x32);
	tp2825_write_register(ViPipe, 0x3B, 0x26);
	tp2825_write_register(ViPipe, 0x3C, 0x00);
	tp2825_write_register(ViPipe, 0x3D, 0x60);
	...
	tp2825_write_register(ViPipe, 0x4C, 0x43);
	tp2825_write_register(ViPipe, 0x4D, 0x00);
	tp2825_write_register(ViPipe, 0x4E, 0x17);
	tp2825_write_register(ViPipe, 0x4F, 0x00);
	tp2825_write_register(ViPipe, 0xF0, 0x00);
	tp2825_write_register(ViPipe, 0xF1, 0x00);
	tp2825_write_register(ViPipe, 0xF2, 0x00);
	...
	tp2825_write_register(ViPipe, 0xFC, 0x00);
	tp2825_write_register(ViPipe, 0x40, 0x08);
	tp2825_write_register(ViPipe, 0x00, 0x00);
	tp2825_write_register(ViPipe, 0x01, 0xf8);
	tp2825_write_register(ViPipe, 0x02, 0x00);
	tp2825_write_register(ViPipe, 0x08, 0xF0);
	tp2825_write_register(ViPipe, 0x13, 0x24);
	tp2825_write_register(ViPipe, 0x14, 0x73);
	tp2825_write_register(ViPipe, 0x15, 0x08);
	tp2825_write_register(ViPipe, 0x20, 0x12);
	tp2825_write_register(ViPipe, 0x34, 0x1b);
	tp2825_write_register(ViPipe, 0x23, 0x02);
	tp2825_write_register(ViPipe, 0x23, 0x00);
	tp2825_write_register(ViPipe, 0x40, 0x00);

	printf("ViPipe:%d,===tp2825 720P 30fps 10bit LINE Init OK!===\n", ViPipe);
}
...
void tp2825_init(VI_PIPE ViPipe)
{
	...
	if (g_pasttp2825[ViPipe]->u8ImgMode == TP2825_MODE_1440P_30P ||
		g_pasttp2825[ViPipe]->u8ImgMode == TP2825_MODE_1440P_25P) {
			tp2825_1440p_init_setting(ViPipe, g_pasttp2825[ViPipe]->u8ImgMode);
	} else if (g_pasttp2825[ViPipe]->u8ImgMode == TP2825_MODE_720P_30P) {
		tp2825_720p_init_setting(ViPipe);
	} else if (g_pasttp2825[ViPipe]->u8ImgMode == TP2825_MODE_1080P_60P ||
		g_pasttp2825[ViPipe]->u8ImgMode == TP2825_MODE_1080P_50P) {
		tp2825_1080p60_init_setting(ViPipe, g_pasttp2825[ViPipe]->u8ImgMode);
	} else if (g_pasttp2825[ViPipe]->u8ImgMode == TP2825_MODE_1080P_30P) {
		tp2825_1080p30_init_setting(ViPipe);
	} else {
		syslog(LOG_ERR, "Techpoint tp2825 not support!\n");
	}
