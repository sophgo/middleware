...
extern CVI_S32 AHD_PR2020_Init(VI_PIPE ViPipe, bool isFirstInit);
extern CVI_S32 AHD_PR2020_Deinit(VI_PIPE ViPipe);
extern CVI_S32 AHD_PR2020_get_mode(VI_PIPE ViPipe);
extern CVI_S32 AHD_PR2020_set_mode(VI_PIPE ViPipe, CVI_S32 mode);
extern CVI_S32 AHD_PR2020_set_bus_info(VI_PIPE ViPipe, CVI_S32 astI2cDev);
extern CVI_S32 AHD_PR2020_detect_status(VI_PIPE ViPipe, CVI_S32 ahdOldType, CVI_S32 *ahdType);
