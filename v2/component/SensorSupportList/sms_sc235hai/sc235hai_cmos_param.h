#ifndef __SC235HAI_CMOS_PARAM_H_
#define __SC235HAI_CMOS_PARAM_H_
...
static const SC235HAI_MODE_S g_astSC235HAI_mode[SC235HAI_MODE_NUM] = {
	[SC235HAI_MODE_1080P15_1L] = {
		.name = "1080p15_1L",
		.astImg[0] = {
			.stSnsSize = {
				.u32Width = 1920,
...
struct combo_dev_attr_s sc235hai_rx_attr = {
	.input_mode = INPUT_MODE_MIPI,
	.mac_clk = RX_MAC_CLK_500M,/** MAC_Freq * pix_width = lane_num * MIPI_Freq * 2*/
	.mipi_attr = {
...
#endif /* __SC235HAI_CMOS_PARAM_H_ */
