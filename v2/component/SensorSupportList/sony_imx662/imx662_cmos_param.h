#ifndef __IMX662_CMOS_PARAM_H_
#define __IMX662_CMOS_PARAM_H_
...
static const IMX662_MODE_S g_astImx662_mode[IMX662_MODE_NUM] = {
	[IMX662_MODE_1080P30] = {
		.name = "1080p30",
		.astImg[0] = {
			.stSnsSize = {
...
static ISP_CMOS_NOISE_CALIBRATION_S g_stIspNoiseCalibratio = {.CalibrationCoef = {
	...
	{	//iso  200
		{0.03635194525122642517,	5.70069074666237304688}, //B: slope, intercept
	...
	{	//iso  25600
		...
		{0.15566282938003540039,	139.79985046386718750000}, //R: slope, intercept
	},
	{	//iso  51200
	...
	{	//iso  102400
		...
		{0.23015110194686624951,	402.12283325195312500000}, //Gr: slope, intercept
...
struct combo_dev_attr_s imx662_rx_attr = {
