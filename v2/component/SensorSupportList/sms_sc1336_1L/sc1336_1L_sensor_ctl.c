...
static void sc1336_1l_linear_600p60_init(VI_PIPE ViPipe);
static void sc1336_1l_linear_600p30_init(VI_PIPE ViPipe);
...
{
	return sensor_i2c_init(ViPipe, (CVI_U8)g_aunSC1336_1L_BusInfo[ViPipe].s8I2cDev,
							(CVI_U8)g_aunSC1336_1L_AddrInfo[ViPipe].s8I2cAddr);
}

int sc1336_1l_i2c_exit(VI_PIPE ViPipe)
{
	return sensor_i2c_exit(ViPipe, (CVI_U8)g_aunSC1336_1L_BusInfo[ViPipe].s8I2cDev);
}

int sc1336_1l_read_register(VI_PIPE ViPipe, int addr)
{
	return sensor_i2c_read(ViPipe, (CVI_U8)g_aunSC1336_1L_BusInfo[ViPipe].s8I2cDev,
							(CVI_U8)g_aunSC1336_1L_AddrInfo[ViPipe].s8I2cAddr, (CVI_U32)addr,
							sc1336_1l_addr_byte, sc1336_1l_data_byte);
}

int sc1336_1l_write_register(VI_PIPE ViPipe, int addr, int data)
{
	return sensor_i2c_write(ViPipe, (CVI_U8)g_aunSC1336_1L_BusInfo[ViPipe].s8I2cDev,
							(CVI_U8)g_aunSC1336_1L_AddrInfo[ViPipe].s8I2cAddr, (CVI_U32)addr,
							sc1336_1l_addr_byte, (CVI_U32)data, sc1336_1l_data_byte);
}
...
void sc1336_1l_init(VI_PIPE ViPipe)
{
	...
	else if ((u8ImgMode == SC1336_1L_MODE_600P30))
		sc1336_1l_linear_600p30_init(ViPipe);
	else if ((u8ImgMode == SC1336_1L_MODE_600P60))
		sc1336_1l_linear_600p60_init(ViPipe);
...
/*****************************************************************/
	...
	sc1336_1l_write_register(ViPipe, 0x301f, 0x14);
	sc1336_1l_write_register(ViPipe, 0x3200, 0x00);
	sc1336_1l_write_register(ViPipe, 0x3201, 0x80);
	sc1336_1l_write_register(ViPipe, 0x3202, 0x00);
	sc1336_1l_write_register(ViPipe, 0x3203, 0x3c);
	sc1336_1l_write_register(ViPipe, 0x3204, 0x04);
	sc1336_1l_write_register(ViPipe, 0x3205, 0x87);
	sc1336_1l_write_register(ViPipe, 0x3206, 0x02);
	sc1336_1l_write_register(ViPipe, 0x3207, 0x9b);
	sc1336_1l_write_register(ViPipe, 0x3208, 0x04);
	sc1336_1l_write_register(ViPipe, 0x3209, 0x00);
	sc1336_1l_write_register(ViPipe, 0x320a, 0x02);
	sc1336_1l_write_register(ViPipe, 0x320b, 0x58);
	sc1336_1l_write_register(ViPipe, 0x3210, 0x00);
	sc1336_1l_write_register(ViPipe, 0x3211, 0x04);
	sc1336_1l_write_register(ViPipe, 0x3212, 0x00);
	sc1336_1l_write_register(ViPipe, 0x3213, 0x04);
...
/*****************************************************************/
	...
	printf("ViPipe:%d,===SC1336_1L 600P 30fps 10bit LINE Init OK!===\n", ViPipe);
}
...
static void sc1336_1l_linear_600p60_init(VI_PIPE ViPipe)
{
	...
	printf("ViPipe:%d,===SC1336_1L 600P 60fps 10bit LINE Init OK!===\n", ViPipe);
}
