...
ISP_SNS_MIRRORFLIP_TYPE_E g_aeSC500AI_MirrorFip[VI_MAX_PIPE_NUM] = {0};
...
static CVI_VOID sensor_mirror_flip(VI_PIPE ViPipe, ISP_SNS_MIRRORFLIP_TYPE_E eSnsMirrorFlip)
{
	...
	if (pstSnsState->bInit == CVI_TRUE && g_aeSC500AI_MirrorFip[ViPipe] != eSnsMirrorFlip) {
		sc500ai_mirror_flip(ViPipe, eSnsMirrorFlip);
		g_aeSC500AI_MirrorFip[ViPipe] = eSnsMirrorFlip;
	}
}
...
static CVI_VOID sensor_ctx_exit(VI_PIPE ViPipe)
{
	...
	g_aeSC500AI_MirrorFip[ViPipe] = ISP_SNS_NORMAL;
}
