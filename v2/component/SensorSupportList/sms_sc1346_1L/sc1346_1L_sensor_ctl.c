...
{
	return sensor_i2c_init(ViPipe, (CVI_U8)g_aunSC1346_1L_BusInfo[ViPipe].s8I2cDev,
							(CVI_U8)g_aunSC1346_1L_AddrInfo[ViPipe].s8I2cAddr);
}

int sc1346_1L_i2c_exit(VI_PIPE ViPipe)
{
		return sensor_i2c_exit(ViPipe, (CVI_U8)g_aunSC1346_1L_BusInfo[ViPipe].s8I2cDev);
}

int sc1346_1L_read_register(VI_PIPE ViPipe, int addr)
{
	return sensor_i2c_read(ViPipe, (CVI_U8)g_aunSC1346_1L_BusInfo[ViPipe].s8I2cDev,
							(CVI_U8)g_aunSC1346_1L_AddrInfo[ViPipe].s8I2cAddr, (CVI_U32)addr,
							sc1346_1L_addr_byte, sc1346_1L_data_byte);
}

int sc1346_1L_write_register(VI_PIPE ViPipe, int addr, int data)
{
	return sensor_i2c_write(ViPipe, (CVI_U8)g_aunSC1346_1L_BusInfo[ViPipe].s8I2cDev,
							(CVI_U8)g_aunSC1346_1L_AddrInfo[ViPipe].s8I2cAddr, (CVI_U32)addr,
							sc1346_1L_addr_byte, (CVI_U32)data, sc1346_1L_data_byte);
}
...
void sc1346_1L_init(VI_PIPE ViPipe)
{
	...
	else if ((u8ImgMode == SC1346_1L_MODE_600P30))
		sc1346_1L_linear_600p30_init(ViPipe);
	else if ((u8ImgMode == SC1346_1L_MODE_600P60))
