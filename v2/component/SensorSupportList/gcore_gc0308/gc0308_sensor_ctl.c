...
{
	return sensor_i2c_init(ViPipe, (CVI_U8)g_aunGc0308_BusInfo[ViPipe].s8I2cDev,
							(CVI_U8)g_aunGc0308_AddrInfo[ViPipe].s8I2cAddr);
}

int gc0308_i2c_exit(VI_PIPE ViPipe)
{
	return sensor_i2c_exit(ViPipe, (CVI_U8)g_aunGc0308_BusInfo[ViPipe].s8I2cDev);
}

int gc0308_read_register(VI_PIPE ViPipe, int addr)
{
	return sensor_i2c_read(ViPipe, (CVI_U8)g_aunGc0308_BusInfo[ViPipe].s8I2cDev,
							(CVI_U8)g_aunGc0308_AddrInfo[ViPipe].s8I2cAddr, (CVI_U32)addr,
							gc0308_addr_byte, gc0308_data_byte);
}

int gc0308_write_register(VI_PIPE ViPipe, int addr, int data)
{
	return sensor_i2c_write(ViPipe, (CVI_U8)g_aunGc0308_BusInfo[ViPipe].s8I2cDev,
							(CVI_U8)g_aunGc0308_AddrInfo[ViPipe].s8I2cAddr, (CVI_U32)addr,
							gc0308_addr_byte, (CVI_U32)data, gc0308_data_byte);
}
...
static void gc0308_linear_480p30_init(VI_PIPE ViPipe)
{
	...
	nVal  = gc0308_read_register(ViPipe, 0x08);
	nVal2 = gc0308_read_register(ViPipe, 0x29);
