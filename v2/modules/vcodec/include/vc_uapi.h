...
#define CVI_VC_VDEC_SET_STRIDE_ALIGN           _IO(CVI_VC_DRV_IOCTL_MAGIC, 109)
#define CVI_VC_VDEC_SET_USER_PIC               _IO(CVI_VC_DRV_IOCTL_MAGIC, 110)
#define CVI_VC_VDEC_ENABLE_USER_PIC            _IO(CVI_VC_DRV_IOCTL_MAGIC, 111)
#define CVI_VC_VDEC_DISABLE_USER_PIC           _IO(CVI_VC_DRV_IOCTL_MAGIC, 112)
#define CVI_VC_VDEC_SET_DISPLAY_MODE           _IO(CVI_VC_DRV_IOCTL_MAGIC, 113)

#define CVI_VC_VENC_SET_EXTERN_BUF             _IO(CVI_VC_DRV_IOCTL_MAGIC, 114)
#define CVI_VC_VENC_ALLOC_PHYSICAL_MEMORY      _IO(CVI_VC_DRV_IOCTL_MAGIC, 115)
#define CVI_VC_VENC_FREE_PHYSICAL_MEMORY       _IO(CVI_VC_DRV_IOCTL_MAGIC, 116)
