...
void *audio_ssp_init(void *para_obj, unsigned int sample_rate)
{
...
#if 0
	LOG_PRINTF("[SSP_VER20220128]user setting config param------dump---start\n");
	LOG_PRINTF("[SSP_VER20220128]==========ssp interface param\n");
	...
	LOG_PRINTF("[SSP_VER20220128]para_delay_sample:%d.\n",  pst3Ainfo->para_obj.para_delay_sample);
	LOG_PRINTF("[SSP_VER20220128]para_dg_target:%d.\n",  pst3Ainfo->para_obj.para_dg_target);
	LOG_PRINTF("[SSP_VER20220128]para_aec_init_filter_len:%d.\n",  pst3Ainfo->para_obj.para_aec_init_filter_len);
	LOG_PRINTF("[SSP_VER20220128]para_aec_filter_len:%d.\n",  pst3Ainfo->para_obj.para_aec_filter_len);
	LOG_PRINTF("[SSP_VER20220128]para_aes_std_thrd:%d.\n",  pst3Ainfo->para_obj.para_aes_std_thrd);
	LOG_PRINTF("[SSP_VER20220128]para_aes_supp_coeff:%d.\n",  pst3Ainfo->para_obj.para_aes_supp_coeff);
	LOG_PRINTF("[SSP_VER20220128]para_nr_init_sile_time:%d.\n",  pst3Ainfo->para_obj.para_nr_init_sile_time);
	LOG_PRINTF("[SSP_VER20220128]para_nr_snr_coeff:%d.\n",  pst3Ainfo->para_obj.para_nr_snr_coeff);
	LOG_PRINTF("[SSP_VER20220128]para_agc_max_gain:%d.\n",  pst3Ainfo->para_obj.para_agc_max_gain);
	LOG_PRINTF("[SSP_VER20220128]para_agc_target_high:%d.\n",  pst3Ainfo->para_obj.para_agc_target_high);
	LOG_PRINTF("[SSP_VER20220128]para_agc_target_low:%d.\n",  pst3Ainfo->para_obj.para_agc_target_low);
	LOG_PRINTF("[SSP_VER20220128]para_agc_vad_ena:%d.\n",  pst3Ainfo->para_obj.para_agc_vad_ena);
	LOG_PRINTF("[SSP_VER20220128]para_notch_freq:%d.\n",  pst3Ainfo->para_obj.para_notch_freq);
	LOG_PRINTF("[SSP_VER20220128]para_nr_noise_coeff:%d.\n",  pst3Ainfo->para_obj.para_nr_noise_coeff);
	LOG_PRINTF("[SSP_VER20220128]para_agc_vad_cnt:%d.\n",  pst3Ainfo->para_obj.para_agc_vad_cnt);
	LOG_PRINTF("[SSP_VER20220128]para_agc_cut6_ena:%d.\n",  pst3Ainfo->para_obj.para_agc_cut6_ena);
	LOG_PRINTF("[SSP_VER20220128]para_spk_fun_config:%d.\n",  pst3Ainfo->para_obj.para_spk_fun_config);
	...
	LOG_PRINTF("[SSP_VER20220128]para_spk_agc_vad_ena:%d.\n",  pst3Ainfo->para_obj.para_spk_agc_vad_ena);
	LOG_PRINTF("[SSP_VER20220128]para_spk_agc_vad_cnt:%d.\n",  pst3Ainfo->para_obj.para_spk_agc_vad_cnt);
	LOG_PRINTF("[SSP_VER20220128]para_spk_agc_cut6_ena:%d.\n",  pst3Ainfo->para_obj.para_spk_agc_cut6_ena);
	LOG_PRINTF("[SSP_VER20220128]user setting config param------dump---end\n");
#else
	LOG_PRINTF("[SSP_VER20220128]user setting config param------dump---start\n");
	LOG_PRINTF("[SSP_VER20220128]sample_rate:%d.\n", (int)pst3Ainfo->fs);
	LOG_PRINTF("[SSP_VER20220128]para_client_config:%d.\n",  pst3Ainfo->para_obj.para_client_config);
