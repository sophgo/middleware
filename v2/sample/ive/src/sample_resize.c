...
int main(int argc, char **argv)
{
	...
	// Create dst image.
	CVI_IVE_CreateImage(handle, &astDst[0], IVE_IMAGE_TYPE_U8C1,
	...
	CVI_IVE_Resize(handle, &astSrc[0], &astDst[0], &stCtrl, 1);
	CVI_IVE_Resize(handle, &astSrc[1], &astDst[1], &stCtrl, 1);
