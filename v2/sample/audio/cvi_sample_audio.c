...
void *AudioAigetdata(void *argv)
{
	...
	stAudioAigetdataPara *stAudioAigetdataPara = argv;
	int AiDev = stAudioAigetdataPara->device;
	int record_time = stAudioAigetdataPara->record_time;
	printf("[debug line %d][%s]AiDev=%d, record_time=%d",__LINE__, __func__, AiDev, record_time);
...
//STEP 3:ai bind aenc
	...
	stAudioAigetdataPara stAudioAigetdataPara;

	stSrcChn.enModId = CVI_ID_AI;
	stSrcChn.s32DevId = AiDev;
	stSrcChn.s32ChnId = AiChn;
	stDestChn.enModId = CVI_ID_AENC;
	stDestChn.s32DevId = AiDev;
	stDestChn.s32ChnId = AeChn;
	stAudioAigetdataPara.record_time = record_time;
	stAudioAigetdataPara.device = AiDev;
	...
	pthread_create(&t_dp, NULL,
		       (void *(*)(void *))AudioAigetdata, (void *)&stAudioAigetdataPara);
