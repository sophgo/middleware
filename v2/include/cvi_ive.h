 ...
 *
 * @param pIveHandle Ive instance handler.
 * @param astSrcDst Inpit image and Dst Image.
 * @param astBlob Connected area information pointer
 * @param astCclCtrl control information.
 * @param bInstant Dummy variable.
 * @return CVI_S32 CVI_S32 Return CVI_SUCCESS if succeed.
 */
