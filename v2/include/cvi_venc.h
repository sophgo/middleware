...
/* Set Custom Map (Unused now)
 *
 * @param VeChn(In): channel number
 * @param pstVeCustomMap(In): pointer to VENC_CUSTOM_MAP_S
 * @return Error code (0 if successful)
 */
 ...
 *
 * @param VeChn(In): channel number
 * @param pstVencInitialInfo(Out): pointer to VENC_INITIAL_INFO_S
 * @return Error code (0 if successful)
 */
 ...
 *
 * @param VeChn(In): channel number
 * @param pstVencSearchWindow(In): pointer to VENC_SEARCH_WINDOW_S
 * @return Error code (0 if successful)
 */
 ...
 *
 * @param VeChn(In): channel number
 * @param pstVencSearchWindow(Out): pointer to VENC_SEARCH_WINDOW_S
 * @return Error code (0 if successful)
 */
