...
typedef struct _ISP_DP_DYNAMIC_MANUAL_ATTR_S {
	...
	CVI_U16 BrightDefectToNormalPixRatio; /*RW; Range:[0x0, 0x3ff]*/
	CVI_U16 DarkDefectToNormalPixRatio; /*RW; Range:[0x0, 0x3ff]*/
...
typedef struct _ISP_DP_DYNAMIC_AUTO_ATTR_S {
	...
	CVI_U16 BrightDefectToNormalPixRatio[ISP_AUTO_ISO_STRENGTH_NUM]; /*RW; Range:[0x0, 0x3ff]*/
	CVI_U16 DarkDefectToNormalPixRatio[ISP_AUTO_ISO_STRENGTH_NUM]; /*RW; Range:[0x0, 0x3ff]*/
...
typedef struct _ISP_NR_MANUAL_ATTR_S {
	...
	CVI_U8 NoiseSuppressStrSE; /*RW; Range:[0x0, 0xff]*/
	CVI_U8 FilterTypeSE; /*RW; Range:[0x0, 0xff]*/
	CVI_U8 NoiseSuppressStrModeSE; /*RW; Range:[0x0, 0xff]*/
...
typedef struct _ISP_NR_AUTO_ATTR_S {
	...
	CVI_U8 NoiseSuppressStrSE[ISP_AUTO_ISO_STRENGTH_NUM]; /*RW; Range:[0x0, 0xff]*/
	CVI_U8 FilterTypeSE[ISP_AUTO_ISO_STRENGTH_NUM]; /*RW; Range:[0x0, 0xff]*/
	CVI_U8 NoiseSuppressStrModeSE[ISP_AUTO_ISO_STRENGTH_NUM]; /*RW; Range:[0x0, 0xff]*/
} ISP_NR_AUTO_ATTR_S;

typedef struct _ISP_NR_ATTR_S {
	CVI_BOOL Enable; /*RW; Range:[0, 1]*/
	CVI_BOOL EnableSE; /*RW; Range:[0, 1]*/
	ISP_OP_TYPE_E enOpType;
	CVI_U8 UpdateInterval; /*RW; Range:[0x1, 0xFF]*/
...
typedef struct _ISP_PRESHARPEN_MANUAL_ATTR_S {
	...
	CVI_U8 EnhanceMode; /*RW; Range:[0x0, 0x1]*/
	CVI_U32 DarkLumaThr; /*RW; Range:[0x0, 0xFFFFF]*/
	CVI_U32 BrightLumaThr; /*RW; Range:[0x0, 0xFFFFF]*/
	CVI_U32 DarkEdgeThr; /*RW; Range:[0x0, 0xFFFFF]*/
	CVI_U32 DarkEdgeStrength; /*RW; Range:[0x0, 0xFFFFF]*/
	CVI_U32 BrightEdgeThr; /*RW; Range:[0x0, 0xFFFFF]*/
	CVI_U32 BrightEdgeStrength; /*RW; Range:[0x0, 0xFFFFF]*/
	CVI_U32 LineThr; /*RW; Range:[0x0, 0xFFFFF]*/
	CVI_U32 LineStrength; /*RW; Range:[0x0, 0xFFFFF]*/
...
typedef struct _ISP_PRESHARPEN_AUTO_ATTR_S {
	...
	CVI_U8 LumaCorLutOut[EE_LUT_NODE][ISP_AUTO_ISO_STRENGTH_NUM]; /*RW; Range:[0x0, 0xff]*/
	CVI_U8 MotionCorLutIn[EE_LUT_NODE][ISP_AUTO_ISO_STRENGTH_NUM]; /*RW; Range:[0x0, 0xff]*/
	CVI_U8 MotionCorLutOut[EE_LUT_NODE][ISP_AUTO_ISO_STRENGTH_NUM]; /*RW; Range:[0x0, 0xff]*/
	...
	CVI_U8 MFCoreGain[ISP_AUTO_ISO_STRENGTH_NUM]; /*RW; Range:[0x0, 0xff]*/
	CVI_U8 GlobalGain[ISP_AUTO_ISO_STRENGTH_NUM]; /*RW; Range:[0x0, 0xff]*/
	CVI_U8 ShootMode[ISP_AUTO_ISO_STRENGTH_NUM]; /*RW; Range:[0x0, 0x01]*/
	...
	CVI_U8 EnhanceMode[ISP_AUTO_ISO_STRENGTH_NUM]; /*RW; Range:[0x0, 0x1]*/
	CVI_U32 DarkLumaThr[ISP_AUTO_ISO_STRENGTH_NUM]; /*RW; Range:[0x0, 0xFFFFF]*/
	CVI_U32 BrightLumaThr[ISP_AUTO_ISO_STRENGTH_NUM]; /*RW; Range:[0x0, 0xFFFFF]*/
	CVI_U32 DarkEdgeThr[ISP_AUTO_ISO_STRENGTH_NUM]; /*RW; Range:[0x0, 0xFFFFF]*/
	CVI_U32 DarkEdgeStrength[ISP_AUTO_ISO_STRENGTH_NUM]; /*RW; Range:[0x0, 0xFFFFF]*/
	CVI_U32 BrightEdgeThr[ISP_AUTO_ISO_STRENGTH_NUM]; /*RW; Range:[0x0, 0xFFFFF]*/
	CVI_U32 BrightEdgeStrength[ISP_AUTO_ISO_STRENGTH_NUM]; /*RW; Range:[0x0, 0xFFFFF]*/
	CVI_U32 LineThr[ISP_AUTO_ISO_STRENGTH_NUM]; /*RW; Range:[0x0, 0xFFFFF]*/
	CVI_U32 LineStrength[ISP_AUTO_ISO_STRENGTH_NUM]; /*RW; Range:[0x0, 0xFFFFF]*/
...
typedef struct _ISP_TNR_MATF_MANUAL_ATTR_S {
	CVI_U8 Enable; /*RW; Range:[0x0, 0x01]*/
	CVI_U8 LowMtPrtAdvIn[4]; /*RW; Range:[0x0, 0xff]*/
	CVI_U8 LowMtPrtAdvOut[4]; /*RW; Range:[0x0, 0xff]*/
	CVI_U8 MaxTFNum; /*RW; Range:[0x0, 0xf]*/
	CVI_U8 MinNoiseLevel; /*RW; Range:[0x0, 0xff]*/
	CVI_U8 MaxNoiseLevel; /*RW; Range:[0x0, 0xff]*/
	CVI_U8 PixelDiffMotionOutThr; /*RW; Range:[0x0, 0xff]*/
	CVI_U8 Vec10; /*RW; Range:[0x0, 0x7]*/
	CVI_U8 Vec20; /*RW; Range:[0x0, 0x7]*/
	CVI_U8 Vec30; /*RW; Range:[0x0, 0x7]*/
} ISP_TNR_MATF_MANUAL_ATTR_S;

typedef struct _ISP_TNR_MATF_AUTO_ATTR_S {
	CVI_U8 Enable[ISP_AUTO_ISO_STRENGTH_NUM]; /*RW; Range:[0x0, 0x01]*/
	CVI_U8 LowMtPrtAdvIn[4][ISP_AUTO_ISO_STRENGTH_NUM]; /*RW; Range:[0x0, 0xff]*/
	CVI_U8 LowMtPrtAdvOut[4][ISP_AUTO_ISO_STRENGTH_NUM]; /*RW; Range:[0x0, 0xff]*/
	CVI_U8 MaxTFNum[ISP_AUTO_ISO_STRENGTH_NUM]; /*RW; Range:[0x0, 0xf]*/
	CVI_U8 MinNoiseLevel[ISP_AUTO_ISO_STRENGTH_NUM]; /*RW; Range:[0x0, 0xff]*/
	CVI_U8 MaxNoiseLevel[ISP_AUTO_ISO_STRENGTH_NUM]; /*RW; Range:[0x0, 0xff]*/
	CVI_U8 PixelDiffMotionOutThr[ISP_AUTO_ISO_STRENGTH_NUM]; /*RW; Range:[0x0, 0xff]*/
	CVI_U8 Vec10[ISP_AUTO_ISO_STRENGTH_NUM]; /*RW; Range:[0x0, 0x7]*/
	CVI_U8 Vec20[ISP_AUTO_ISO_STRENGTH_NUM]; /*RW; Range:[0x0, 0x7]*/
	CVI_U8 Vec30[ISP_AUTO_ISO_STRENGTH_NUM]; /*RW; Range:[0x0, 0x7]*/
} ISP_TNR_MATF_AUTO_ATTR_S;

typedef struct _ISP_TNR_MATF_ATTR_S {
	ISP_TNR_MATF_MANUAL_ATTR_S stManual;
	ISP_TNR_MATF_AUTO_ATTR_S stAuto;
} ISP_TNR_MATF_ATTR_S;
...
//  RGBIR
//-----------------------------------------------------------------------------
typedef struct _ISP_RGBIR_MANUAL_ATTR_S {
	CVI_U16 u16RecGbrGain; /*RW; Range:[0x0, 0xFFF]*/
	CVI_U16 u16RecGbrOffset; /*RW; Range:[0x0, 0xFFF]*/
	CVI_U16 u16RecGirGain; /*RW; Range:[0x0, 0xFFF]*/
	CVI_U16 u16RecGirOffset; /*RW; Range:[0x0, 0xFFF]*/
	CVI_U16 u16RecRgGain; /*RW; Range:[0x0, 0xFFF]*/
	CVI_U16 u16RecRgOffset; /*RW; Range:[0x0, 0xFFF]*/
	CVI_U16 u16RecBgGain; /*RW; Range:[0x0, 0xFFF]*/
	CVI_U16 u16RecBgOffset; /*RW; Range:[0x0, 0xFFF]*/
} ISP_RGBIR_MANUAL_ATTR_S;

typedef struct _ISP_RGBIR_AUTO_ATTR_S {
	CVI_U16 u16RecGbrGain[ISP_AUTO_ISO_STRENGTH_NUM]; /*RW; Range:[0x0, 0xFFF]*/
	CVI_U16 u16RecGbrOffset[ISP_AUTO_ISO_STRENGTH_NUM]; /*RW; Range:[0x0, 0xFFF]*/
	CVI_U16 u16RecGirGain[ISP_AUTO_ISO_STRENGTH_NUM]; /*RW; Range:[0x0, 0xFFF]*/
	CVI_U16 u16RecGirOffset[ISP_AUTO_ISO_STRENGTH_NUM]; /*RW; Range:[0x0, 0xFFF]*/
	CVI_U16 u16RecRgGain[ISP_AUTO_ISO_STRENGTH_NUM]; /*RW; Range:[0x0, 0xFFF]*/
	CVI_U16 u16RecRgOffset[ISP_AUTO_ISO_STRENGTH_NUM]; /*RW; Range:[0x0, 0xFFF]*/
	CVI_U16 u16RecBgGain[ISP_AUTO_ISO_STRENGTH_NUM]; /*RW; Range:[0x0, 0xFFF]*/
	CVI_U16 u16RecBgOffset[ISP_AUTO_ISO_STRENGTH_NUM]; /*RW; Range:[0x0, 0xFFF]*/
} ISP_RGBIR_AUTO_ATTR_S;

typedef struct _ISP_RGBIR_ATTR_S {
	CVI_BOOL Enable; /*RW; Range:[0x0, 0x1]*/
	ISP_OP_TYPE_E enOpType;
	CVI_U8 UpdateInterval; /*RW; Range:[0x1, 0xFF]*/
	ISP_BAYER_FORMAT_E enIrBayerFormat;
	CVI_BOOL bLumaCompEnable; /*RW; Range:[0x0, 0x1]*/
	CVI_U8 u8RCompGain; /*RW; Range:[0x0, 0xF]*/
	CVI_U8 u8GCompGain; /*RW; Range:[0x0, 0xF]*/
	CVI_U8 u8BCompGain; /*RW; Range:[0x0, 0xF]*/
	CVI_U8 u8DebugMode; /*RW; Range:[0x0, 0xF]*/
	ISP_RGBIR_MANUAL_ATTR_S stManual;
	ISP_RGBIR_AUTO_ATTR_S stAuto;
} ISP_RGBIR_ATTR_S;
...
typedef struct _TEAISP_BNR_MANUAL_ATTR_S {
	...
	CVI_U8 NoiseHiLevel; /*RW; Range:[0x0, 0xFF]*/
...
typedef struct _TEAISP_BNR_AUTO_ATTR_S {
	...
	CVI_U8 NoiseHiLevel[ISP_AUTO_ISO_STRENGTH_NUM]; /*RW; Range:[0x0, 0xFF]*/
