...
#define DWA_FILE_OUT_FISHEYE_PANORAMA_180       "res/output/fisheye_floor_panorama180_1280x720.yuv"
#define DWA_FILE_OUT_FISHEYE_02_1O4R            "res/output/fisheye_floor_02_1O4R_1280x720.yuv"
#define DWA_FILE_OUT_FISHEYE_03_4R              "res/output/fisheye_floor_03_4R_1280x720.yuv"
#define DWA_FILE_OUT_FISHEYE_04_1P2R            "res/output/fisheye_floor_04_1P2R_1280x720.yuv"
#define DWA_FILE_OUT_FISHEYE_05_1P2R            "res/output/fisheye_floor_05_1P2R_1280x720.yuv"
#define DWA_FILE_OUT_FISHEYE_06_1P              "res/output/fisheye_floor_06_1P_1280x720.yuv"
#define DWA_FILE_OUT_FISHEYE_07_2P              "res/output/fisheye_floor_07_2P_1280x720.yuv"
#define DWA_FILE_PEF_FISHEYE_PANORAMA           "res/pef/fisheye_floor_panorama360_1280x720.yuv"
#define DWA_FILE_PEF_FISHEYE_PANORAMA_180       "res/pef/fisheye_floor_panorama180_1280x720.yuv"
#define DWA_FILE_PEF_FISHEYE_02_1O4R            "res/pef/fisheye_floor_02_1O4R_1280x720.yuv"
#define DWA_FILE_PEF_FISHEYE_03_4R              "res/pef/fisheye_floor_03_4R_1280x720.yuv"
#define DWA_FILE_PEF_FISHEYE_04_1P2R            "res/pef/fisheye_floor_04_1P2R_1280x720.yuv"
#define DWA_FILE_PEF_FISHEYE_05_1P2R            "res/pef/fisheye_floor_05_1P2R_1280x720.yuv"
#define DWA_FILE_PEF_FISHEYE_06_1P              "res/pef/fisheye_floor_06_1P_1280x720.yuv"
#define DWA_FILE_PEF_FISHEYE_07_2P              "res/pef/fisheye_floor_07_2P_1280x720.yuv"
...
#define DWA_FILE_IN_FISHEYE_GRID_INFO_L             "res/input/dc_src_2240x2240_L.yuv"
#define DWA_FILE_OUT_FISHEYE_GRID_INFO_L            "res/output/imgL_2240x2240.yuv"
#define DWA_FILE_IN_FISHEYE_GRID_INFO_R             "res/input/dc_src_2240x2240_R.yuv"
#define DWA_FILE_OUT_FISHEYE_GRID_INFO_R            "res/output/imgR_2240x2240.yuv"
#define DWA_FILE_IN_FISHEYE_GRID_L                  "res/input/L_grid_info_68_68_4624_70_70_dst_2240x2240_src_2240x2240.dat"
#define DWA_FILE_IN_FISHEYE_GRID_R                  "res/input/R_grid_info_68_68_4624_70_70_dst_2240x2240_src_2240x2240.dat"
...
exit2:
	...
	CVI_DWA_FreeCurTaskMesh(param->stTask.name);
...
static CVI_S32 dwa_test_fisheye(CVI_VOID)
{
	...
	int cnt = 8;
	char *filename_in[8] = {DWA_FILE_IN_FISHEYE, DWA_FILE_IN_FISHEYE, DWA_FILE_IN_FISHEYE, DWA_FILE_IN_FISHEYE, \
		DWA_FILE_IN_FISHEYE, DWA_FILE_IN_FISHEYE, DWA_FILE_IN_FISHEYE, DWA_FILE_IN_FISHEYE};
	char *filename_out[8] = {DWA_FILE_OUT_FISHEYE_PANORAMA, DWA_FILE_OUT_FISHEYE_PANORAMA_180, DWA_FILE_OUT_FISHEYE_02_1O4R, \
		DWA_FILE_OUT_FISHEYE_03_4R, DWA_FILE_OUT_FISHEYE_04_1P2R, DWA_FILE_OUT_FISHEYE_05_1P2R, DWA_FILE_OUT_FISHEYE_06_1P, DWA_FILE_OUT_FISHEYE_07_2P};
	char *filename_pef[8] = {DWA_FILE_PEF_FISHEYE_PANORAMA, DWA_FILE_PEF_FISHEYE_PANORAMA_180, DWA_FILE_PEF_FISHEYE_02_1O4R, \
		DWA_FILE_PEF_FISHEYE_03_4R, DWA_FILE_PEF_FISHEYE_04_1P2R, DWA_FILE_PEF_FISHEYE_05_1P2R, DWA_FILE_PEF_FISHEYE_06_1P, DWA_FILE_PEF_FISHEYE_07_2P};
...
static CVI_S32 dwa_test_cmdq(CVI_VOID)
{
	...
	exit2:
		if (s32Ret)
			if (param.hHandle)
				s32Ret |= CVI_DWA_CancelJob(param.hHandle);
		CVI_DWA_FreeCurTaskMesh(stTask_1st.name);
		CVI_DWA_FreeCurTaskMesh(stTask_2nd.name);
		s32Ret |= CVI_DWA_DeInit();
		if (s32Ret) {
			DWA_UT_PRT("CVI_DWA_DeInit fail.\n");
		}
	...
	exit2:
		if (s32Ret)
			if (param.hHandle)
				s32Ret |= CVI_DWA_CancelJob(param.hHandle);
		CVI_DWA_FreeCurTaskMesh(param.stTask.name);
		CVI_DWA_FreeCurTaskMesh(stTask_tmp.name);
		s32Ret |= CVI_DWA_DeInit();
		if (s32Ret) {
			DWA_UT_PRT("CVI_DWA_DeInit fail.\n");
		}
...
exit2:
	...
	for (CVI_U8 i = 0; i < 4; i++) {
		...
		CVI_DWA_FreeCurTaskMesh(param_mix[i].stTask.name);
	}
	s32Ret |= CVI_DWA_DeInit();
	if (s32Ret) {
		DWA_UT_PRT("CVI_DWA_DeInit fail.\n");
...
static CVI_S32 dwa_test_pef2(void)
{
	CVI_S32 s32Ret = CVI_SUCCESS;
	p_func test_func[1] = {dwa_test_ldc};
	bEnProc = CVI_TRUE;
...
static CVI_S32 dwa_test_dewarp_grid_info(CVI_VOID)
{
	CVI_S32 s32Ret = CVI_SUCCESS;
	VB_CONFIG_S stVbConf;
	WARP_ATTR_S stWarpAttr[2] = {0};
	...
	for (int i = 0; i < 2; i++) {
		...
		snprintf(param[i].stTask.name, sizeof(param[i].stTask.name), "dwa_tsk_dewarp_grid_%d", i);
		param[i].identity.enModId = CVI_ID_USER;
		param[i].identity.u32ID = 0;
		snprintf(param[i].identity.Name, sizeof(param[i].identity.Name), "dwa_job_dewarp_grid_%d", i);
		param[i].identity.syncIo = (i==0 ? CVI_FALSE : CVI_TRUE);

		stWarpAttr[i].bEnable = CVI_TRUE;
		stWarpAttr[i].stGridInfoAttr.Enable = CVI_TRUE;
		strcpy(stWarpAttr[i].stGridInfoAttr.gridFileName, filename_grid[i]);
		strcpy(stWarpAttr[i].stGridInfoAttr.gridBindName, param[i].stTask.name);
	}
	...
	do {
		...
		s32Ret = CVI_DWA_AddDewarpTask(param[0].hHandle, &param[0].stTask, &stWarpAttr[0]);
		if (s32Ret) {
			DWA_UT_PRT("CVI_DWA_AddDewarpTask failed!\n");
		}
		s32Ret = CVI_DWA_AddDewarpTask(param[1].hHandle, &param[1].stTask, &stWarpAttr[1]);
		if (s32Ret) {
			DWA_UT_PRT("CVI_DWA_AddDewarpTask failed!\n");
		}
...
static CVI_S32 dwa_test_fisheye_grid_info(CVI_VOID)
{
	CVI_S32 s32Ret = CVI_SUCCESS;
	VB_CONFIG_S stVbConf;
	FISHEYE_ATTR_S stFisheyeAttr[2] = {0};
	DWA_BASIC_TEST_PARAM param[2] = {0};
	...
	for (int i = 0; i < 2; i++) {
		...
		strcpy(param[i].filename_in, filename_in[i]);
		strcpy(param[i].filename_out, filename_out[i]);
		param[i].size_in.u32Width = 2240;
		param[i].size_in.u32Height = 2240;
		param[i].size_out.u32Width = 2240;
		param[i].size_out.u32Height = 2240;
		param[i].enPixelFormat = PIXEL_FORMAT_YUV_PLANAR_420;
		snprintf(param[i].stTask.name, sizeof(param[i].stTask.name), "dwa_tsk_fisheye_grid_%d", i);
		param[i].identity.enModId = CVI_ID_USER;
		param[i].identity.u32ID = 0;
		snprintf(param[i].identity.Name, sizeof(param[i].identity.Name), "dwa_job_fisheye_grid_%d", i);
		param[i].identity.syncIo = (i==0 ? CVI_FALSE : CVI_TRUE);

		param[i].op = DWA_TEST_FISHEYE;
		stFisheyeAttr[i].bEnable = CVI_TRUE;
		stFisheyeAttr[i].stGridInfoAttr.Enable = CVI_TRUE;
		strcpy(stFisheyeAttr[i].stGridInfoAttr.gridFileName, filename_grid[i]);
		strcpy(stFisheyeAttr[i].stGridInfoAttr.gridBindName, param[i].stTask.name);

		param[i].u32BlkSizeIn = COMMON_GetPicBufferSize(param[i].size_in.u32Width, param[i].size_in.u32Height, param[i].enPixelFormat
			, DATA_BITWIDTH_8, COMPRESS_MODE_NONE, DWA_STRIDE_ALIGN);
		param[i].u32BlkSizeOut = COMMON_GetPicBufferSize(param[i].size_out.u32Width, param[i].size_out.u32Height, param[i].enPixelFormat
			, DATA_BITWIDTH_8, COMPRESS_MODE_NONE, DWA_STRIDE_ALIGN);
	}

	memset(&stVbConf, 0, sizeof(VB_CONFIG_S));
	stVbConf.u32MaxPoolCnt              = 1;
	stVbConf.astCommPool[0].u32BlkSize	= param[1].u32BlkSizeOut;
	stVbConf.astCommPool[0].u32BlkCnt	= 8;
	stVbConf.astCommPool[0].enRemapMode	= VB_REMAP_MODE_CACHED;
	DWA_UT_PRT("common pool[0] BlkSize %d\n", param[1].u32BlkSizeIn);
	...
	do {
		...
		s32Ret = CVI_DWA_AddCorrectionTask(param[0].hHandle, &param[0].stTask, &stFisheyeAttr[0]);
		if (s32Ret) {
			DWA_UT_PRT("CVI_DWA_AddCorrectionTask failed!\n");
		}

		s32Ret = CVI_DWA_AddCorrectionTask(param[1].hHandle, &param[1].stTask, &stFisheyeAttr[1]);
		if (s32Ret) {
			DWA_UT_PRT("CVI_DWA_AddCorrectionTask failed!\n");
		}
...
static CVI_S32 _dwa_handle_op(CVI_S32 op)
{
	...
	case DWA_TEST_PEF:
		...
		break;
	case DWA_TEST_PEF2:
		s32Ret = dwa_test_pef2();
		break;
	case DWA_TEST_DEWARP_GRID_INFO:
		s32Ret = dwa_test_dewarp_grid_info();
		break;
	case DWA_TEST_LDC_GRID_INFO:
		s32Ret = dwa_test_ldc_grid_info();
		break;
	case DWA_TEST_FISHEYE_GRID_INFO:
		s32Ret = dwa_test_fisheye_grid_info();
		break;
	case DWA_TEST_RST:
...
static void dwa_show_help(void)
{
	...
	DWA_UT_PRT("%4d: dwa basic test pef2\n", DWA_TEST_PEF2);
	DWA_UT_PRT("%4d: dwa basic test dewarp grid_info\n", DWA_TEST_DEWARP_GRID_INFO);
