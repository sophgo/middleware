...
#ifndef SRC_CORE_IDENTIFICATION_IDENTIFICATION_REG_H_
#define SRC_CORE_IDENTIFICATION_IDENTIFICATION_REG_H_
...
#endif /* SRC_CORE_IDENTIFICATION_IDENTIFICATION_REG_H_ */
