...
#define LT_1_65GBPS_TXTERM 		0x0004
#define LT_1_65GBPS_VLEVCTRL 	0x01E0
#define LT_1_65GBPS_CKSYMTXCTRL 0x80C8

#define LT_3_40GBPS_TXTERM 		0x0004
#define LT_3_40GBPS_VLEVCTRL 	0x0180
#define LT_3_40GBPS_CKSYMTXCTRL 0x83C8

#define GT_3_40GBPS_TXTERM 		0x0000
#define GT_3_40GBPS_VLEVCTRL 	0x0120
#define GT_3_40GBPS_CKSYMTXCTRL 0x80F5
...
static struct phy_config phy312[] = {
...
int phy312_configure_supported(hdmi_tx_dev_t *dev, double pClk, color_depth_t color,
		pixel_repetition_t pixel)
{
	...
	for (i = 0; phy312[i].clock != 0; i++ ){
		if(double_is_equal(pClk, phy312[i].clock) &&
				(color == phy312[i].color) &&
				(pixel == phy312[i].pixel)){
			return TRUE;
		}
	}
...
struct phy_config * phy312_get_configs(double pClk, color_depth_t color,
		pixel_repetition_t pixel)
{
...
int phy312_configure(hdmi_tx_dev_t *dev, double pClk, color_depth_t color, pixel_repetition_t pixel)
{
	int i   = 0;
	u32 phyRead = 0;
	u8 lock = 0;
	...
	config = phy312_get_configs(pClk, color, pixel);
