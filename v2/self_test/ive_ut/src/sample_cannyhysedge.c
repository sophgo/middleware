...
int test_cannyhysedge(int bTileMode, int bWrite, int bInstant)
{
	...
	// char *output_data_Mem3x3 = NULL;
	// char *output_data_5x5 = NULL;
	// char *output_data_Mem5x5 = NULL;
	char input_data[64];
	...
	if (bTileMode) {
		...
		// output_data_3x3 = data_tile_CannyHysEdge_3x3;
		// output_data_Mem3x3 = data_tile_CannyHysEdge_Mem3x3;
		// output_data_5x5 = data_tile_CannyHysEdge_5x5;
		// output_data_Mem5x5 = data_tile_CannyHysEdge_Mem5x5;
		...
		// output_data_3x3 = data_CannyHysEdge_3x3;
		// output_data_Mem3x3 = data_CannyHysEdge_Mem3x3;
		// output_data_5x5 = data_CannyHysEdge_5x5;
		// output_data_Mem5x5 = data_CannyHysEdge_Mem5x5;
