...
static CVI_S32 sensor_rx_attr(VI_PIPE ViPipe, SNS_COMBO_DEV_ATTR_S *pstRxAttr)
{
	...
	pstRxAttr->img_size.width = g_astSC1330_mode[pstSnsState->u8ImgMode].astImg->stSnsSize.u32Width;
	pstRxAttr->img_size.height = g_astSC1330_mode[pstSnsState->u8ImgMode].astImg->stSnsSize.u32Height;
	if (pstSnsState->enWDRMode == WDR_MODE_NONE) {
