...
CVI_S32 CVI_GDC_UpdateDWAModel(char *ptb_path);
CVI_S32 CVI_GDC_CNV_UpdateDWAModel(uint32_t *poffset, char *ptb_path, char *pidl_path);
CVI_S32 CVI_GDC_CNV_DO_DWA(GDC_HANDLE hHandle, GDC_TASK_ATTR_S *stTask);
